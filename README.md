...
<!-- tensortonic:start -->
# Chi Vinh Nhan Nguyen's TensorTonic Solutions

Verified machine learning implementations completed on [TensorTonic](https://www.tensortonic.com).

<p align="center">
  <img src="https://www.tensortonic.com/api/badge/nhanncv.svg" alt="TensorTonic Verified Solutions" width="100%" />
</p>
...
| Build the Legal Go Action Mask | Evaluate every intersection action under occupancy, capture, suicide, and positional-superko rules, then append pass at the final action index. | https://www.tensortonic.com/study-plans/alphago-from-scratch/alphago-l01-legal-action-mask |
| Apply a Go Action with Captures and Repetition | Apply an already-legal Go action, resolve captures, and update the player, pass count, move count, and terminal status. | https://www.tensortonic.com/study-plans/alphago-from-scratch/alphago-l01-resolve-move |
| Score a Terminal Position with Tromp-Taylor Rules | Score a terminal Go board with Tromp-Taylor area rules by counting stones and empty regions controlled by each player. | https://www.tensortonic.com/study-plans/alphago-from-scratch/alphago-l01-tromp-taylor-result |
...
View my verified ML profile: [TensorTonic profile](https://www.tensortonic.com/profile/nhanncv)
<!-- tensortonic:end -->
