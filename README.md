...
| Apply a Go Action with Captures and Repetition | Apply one Go action under capture, suicide, positional-superko, pass, and terminal-state rules. | https://www.tensortonic.com/study-plans/alphago-from-scratch/alphago-l01-resolve-move |
